...
__all__ = [
    ...
    'Speech_StreamPos_Asap', 'STCInprocHandler', 'SRAExport',
    'DISPID_SRSClsidEngine', 'SPEI_RESERVED5',
    'DISPID_SpeechBaseStream', '_RemotableHandle',
    'DISPID_SPEAudioTimeOffset', 'SGPronounciation',
    'DISPID_SWFEFormatTag', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SpeechPhraseElement',
    'DISPID_SGRSAddRuleTransition', 'ISpeechPhraseElements',
    'SPDKL_DefaultLocation', 'DISPID_SPIRule', 'SAFT22kHz8BitMono',
    'DISPID_SVEAudioLevel', 'DISPID_SGRSTText', 'SpNotifyTranslator',
    'IEnumString', 'DISPID_SRCEStartStream', 'SpeechAudioState',
    'SVP_15', 'DISPID_SRCEEnginePrivate', 'SAFTADPCM_44kHzMono',
    'DISPID_SPRuleName', 'DISPID_SVEPhoneme', 'ISpeechPhoneConverter',
    'DISPID_SPIEngineId', 'SpeechSpecialTransitionType',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRCState', 'SPEI_MIN_SR',
    'DISPID_SLPsItem', 'SpeechDataKeyLocation',
    'SAFTADPCM_44kHzStereo', 'DISPID_SpeechPhraseBuilder',
    'SPPS_RESERVED4', 'ISpeechPhraseAlternate', 'eLEXTYPE_USER',
    'DISPID_SCSBaseStream', 'IInternetSecurityManager',
    'DISPID_SpeechPhraseProperties', 'STSF_FlagCreate',
    'SAFTADPCM_22kHzMono', 'SPAR_Low', 'SREHypothesis',
    'SpUnCompressedLexicon', 'DISPID_SRCVoice', 'SP_VISEME_10',
    'SPPS_NotOverriden', 'SRTStandard', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPIAudioSizeBytes', 'Speech_StreamPos_RealTime',
    'DISPID_SPPName', 'SRSActiveAlways',
    'DISPIDSPTSI_SelectionOffset', 'SPXMLRESULTOPTIONS',
    'SpeechLoadOption', 'DISPID_SVSRunningState', 'SPRULESTATE',
    'SASClosed', 'DISPID_SRCEInterference', 'ISpEventSink',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRCreateRecoContext',
    'eLEXTYPE_LETTERTOSOUND', 'SPFM_CREATE',
    'DISPID_SRCRetainedAudio', 'DISPIDSPRG', 'DISPID_SPIProperties',
    'DISPID_SRGetFormat', 'SPWORDTYPE', 'SVP_17', 'DISPID_SPCLangId',
    'DISPID_SRRTimes', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPSHT_EMAIL',
    'SpeechPropertyHighConfidenceThreshold', 'SGSEnabled',
    'SPAO_RETAIN_AUDIO', 'UINT_PTR', 'SAFT48kHz8BitStereo',
    'DISPID_SPRDisplayAttributes', 'SpeechRecoProfileProperties',
    'SpeechCategoryPhoneConverters', 'SpMMAudioIn', 'ISpRecoGrammar',
    'DISPID_SpeechMemoryStream', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPEI_MIN_TTS', 'DISPID_SLWPronunciations', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SPIElements', 'SVP_7', 'SpeechPropertyResourceUsage',
    'SSSPTRelativeToEnd', 'DISPID_SVSLastBookmark', 'SVP_3',
    'SVSFNLPSpeakPunc', 'DISPID_SLPPartOfSpeech',
    'DISPID_SVSInputSentenceLength', 'SPPS_Noun', 'DISPID_SGRName',
    'SpeechPropertyAdaptationOn', 'DISPID_SGRSTPropertyName',
    'DISPID_SpeechVoiceEvent', 'DISPID_SLWWord', 'SPEI_MAX_TTS',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SASCurrentSeekPosition',
    'SpeechDiscardType', 'SPSUnknown',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SPILanguageId',
    'SpeechFormatType', 'DISPID_SRCEPropertyNumberChange',
    'ISpRecognizer3', 'SVESentenceBoundary',
    'DISPID_SPERetainedSizeBytes', 'SVSFIsNotXML', 'ISpNotifySink',
    'DISPID_SPISaveToMemory', 'SpeechGrammarTagDictation',
    'SpeechStreamSeekPositionType', 'SAFTADPCM_8kHzStereo',
    'Speech_Default_Weight', 'SVEWordBoundary', 'SRERequestUI',
    'SP_VISEME_14', 'eLEXTYPE_PRIVATE10', 'SAFTNonStandardFormat',
    'DISPID_SOTCSetId', 'DISPID_SGRsCount', 'SPEI_VISEME',
    'SPEI_WORD_BOUNDARY', 'ISpEventSource', 'DISPID_SpeechMMSysAudio',
    'SAFTCCITT_ALaw_22kHzMono', 'SITooFast', 'eLEXTYPE_PRIVATE3',
    'SPSSuppressWord', 'DISPID_SRGCmdLoadFromResource',
    'ISpeechFileStream', 'DISPID_SRCEFalseRecognition',
    'DISPID_SLPPhoneIds', 'DISPID_SLGenerationId', 'SRAImport',
    'ISpRecoContext', 'SPEI_REQUEST_UI', 'ISpPhoneConverter',
    'DISPID_SVEEnginePrivate', 'DISPID_SPEDisplayText',
    'DISPID_SOTIsUISupported', 'DISPID_SGRSTRule',
    'SAFT44kHz8BitStereo', 'SPBO_TIME_UNITS',
    ...
    'DISPID_SAFSetWaveFormatEx', 'SpeechTokenShellFolder', 'ISpAudio',
    'DISPID_SPIStartTime', 'SVSFParseSsml', 'SPSNoun',
    'SpeechRetainedAudioOptions', 'SBONone', 'SpeechRecognizerState',
    'DISPID_SRCEHypothesis', 'DISPID_SFSOpen',
    'DISPIDSPTSI_ActiveOffset', 'eLEXTYPE_RESERVED8',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SOTsItem',
    'SPCT_COMMAND', 'SpFileStream', 'SPDKL_LocalMachine',
    'DISPID_SDKGetStringValue', 'SPFILEMODE', 'DISPID_SRDisplayUI',
    'DISPID_SRCEAdaptation', 'DISPID_SVGetAudioOutputs',
    'DISPID_SVSCurrentStreamNumber', 'SAFT8kHz16BitStereo',
    'SpeechEngineConfidence', 'SPEI_RESERVED2', 'SRTEmulated',
    'SPSMF_SAPI_PROPERTIES', 'SPLO_STATIC', 'SpeechGrammarState',
    'DISPID_SOTMatchesAttributes', 'SAFT44kHz16BitMono',
    'ISpeechMemoryStream', 'DISPID_SRRSaveToMemory',
    'ISpeechPhraseProperties', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRCEventInterests', 'SP_VISEME_16',
    'SAFT11kHz16BitStereo', 'SpLexicon', 'DISPID_SADefaultFormat',
    'DISPID_SpeechDataKey', 'SPBO_PAUSE', 'SREAdaptation',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SMSSetData',
    'ISpeechRecoResultTimes', 'SpeechDictationTopicSpelling',
    'DISPID_SPERetainedStreamOffset', 'eLEXTYPE_PRIVATE8',
    '_ISpeechVoiceEvents', 'SRAInterpreter',
    'DISPID_SRGCmdSetRuleState', 'eLEXTYPE_PRIVATE17',
    'DISPID_SVSLastResult', 'SP_VISEME_9', 'DISPID_SPRulesItem',
    'SAFT32kHz16BitMono', 'SPEI_PROPERTY_STRING_CHANGE',
    'ISpeechRecoResult', 'SAFT12kHz8BitStereo', 'SRESoundStart',
    'DISPID_SOTs_NewEnum', 'DISPID_SRSAudioStatus', 'SASPause',
    'SVP_9', 'DISPID_SVRate', 'SPRS_ACTIVE', 'ISpLexicon',
    'SWPKnownWordPronounceable', 'SSTTDictation', 'SVF_Stressed',
    'DISPID_SPCIdToPhone', 'ISpeechGrammarRuleStateTransition',
    'SpSharedRecoContext', 'SBOPause', 'ISpeechPhraseReplacement',
    'DISPID_SOTId', 'DISPID_SpeechAudioFormat', 'ISpeechLexicon',
    'SDTLexicalForm', 'SVSFParseMask', 'DISPID_SOTCGetDataKey',
    'SVSFVoiceMask', 'SDKLLocalMachine', 'DISPID_SpeechVoiceStatus',
    ...
    'SpCustomStream', 'DISPID_SpeechCustomStream', 'SRSEDone',
    'SPSHORTCUTTYPE', 'SPPS_RESERVED3', 'SPWORDPRONUNCIATIONLIST',
    'ISpeechLexiconWord', 'DISPID_SVSpeakCompleteEvent', 'SPBO_NONE',
    'SREPropertyNumChange', 'DISPID_SRRTTickCount',
    'DISPID_SBSFormat', 'SAFTCCITT_ALaw_8kHzStereo', 'SVP_12',
    'SpeechTokenKeyAttributes', 'SPWAVEFORMATTYPE',
    'SpeechVisemeType', 'DISPID_SRRPhraseInfo', 'SVP_11',
    'SVSFNLPMask', 'DISPID_SLAddPronunciation',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechRecognizerStatus',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpPhoneticAlphabetConverter',
    'DISPID_SRProfile', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SLRemovePronunciation', 'SpeechGrammarTagWildcard',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRSRule',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SPIReplacements',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPIDSPTSI_SelectionLength', 'SVPNormal', 'SpMemoryStream',
    'SDA_Two_Trailing_Spaces', 'ISpObjectTokenCategory',
    'SAFTADPCM_22kHzStereo', 'SDTRule', 'DISPID_SRCBookmark', 'SVP_8',
    'DISPID_SVIsUISupported', 'SPRECOGNIZERSTATUS',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPINTERFERENCE',
    'SpObjectToken', 'SITooQuiet', 'DISPID_SPRules_NewEnum',
    'DISPID_SPAsCount', 'SP_VISEME_21', 'eLEXTYPE_PRIVATE4',
    'SpeechGrammarWordType', 'DISPID_SRCCreateGrammar',
    'SPEI_SOUND_START', 'SREAllEvents', 'SVP_0',
    'DISPID_SPEPronunciation', 'SPEVENT', 'SAFT44kHz8BitMono',
    'SPGRAMMARWORDTYPE', 'DISPID_SOTSetId', 'SRTSMLTimeout',
    'SPSFunction', 'SpeechRecognitionType', 'SVSFDefault',
    'SAFT24kHz16BitMono', 'SpeechWordPronounceable',
    'DISPID_SRRecognizer', 'ISpRecoCategory', 'DISPID_SOTsCount',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SGRSTNextState',
    'ISpeechGrammarRuleState', 'SP_VISEME_17', 'SVEBookmark',
    'SpeechVoicePriority', 'SAFTGSM610_22kHzMono', 'SRSEIsSpeaking',
    'SRARoot', 'DISPID_SGRSTsCount', 'DISPID_SVSInputWordLength',
    'SAFT12kHz16BitMono', 'DISPID_SRCResume', 'eLEXTYPE_PRIVATE18',
    'SpObjectTokenCategory', 'SASStop', 'SSTTTextBuffer',
    'SAFT16kHz16BitStereo', 'DISPID_SpeechVoice', 'DISPID_SOTDataKey',
    'SPSERIALIZEDRESULT', 'SREAudioLevel', 'DISPID_SDKGetBinaryValue',
    'DISPID_SpeechPhoneConverter', 'SpeechAudioFormatType',
    'DISPID_SpeechObjectTokens', 'SPPS_RESERVED2',
    'DISPID_SPEActualConfidence', 'DISPID_SPEs_NewEnum',
    'DISPID_SRIsUISupported', 'DISPID_SAFType',
    'DISPID_SRCERecognition', 'DISPID_SOTGetStorageFileName',
    'DISPID_SPIEnginePrivateData', 'SP_VISEME_20',
    'ISpeechRecoResult2', 'SPINTERFERENCE_TOOFAST', 'SPAUDIOOPTIONS',
    'SDKLCurrentUser', 'DISPID_SVEBookmark',
    'DISPID_SpeechRecoContext', 'SVP_1', 'SP_VISEME_8', 'SPBO_AHEAD',
    ...
    'DISPID_SRCRecognizer', 'SpResourceManager', 'SGRSTTWord',
    'SpeechEmulationCompareFlags', 'SPRECOSTATE',
    'DISPID_SRSCurrentStreamPosition', 'SLTApp', 'SPEI_END_SR_STREAM',
    'DISPID_SDKOpenKey', 'SPVPRI_NORMAL', 'DISPID_SDKDeleteKey',
    'SPEI_HYPOTHESIS', 'SVP_10', 'ISpObjectWithToken',
    'SAFTGSM610_44kHzMono', 'SAFT24kHz8BitMono', 'SP_VISEME_6',
    'DISPID_SOTCEnumerateTokens', 'SPINTERFERENCE_TOOLOUD',
    'SDTPronunciation', 'SpeechPropertyLowConfidenceThreshold',
    'SVEEndInputStream', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPPHRASE', 'ISpeechVoice', 'SAFTCCITT_ALaw_44kHzStereo',
    'SVSFIsXML', 'DISPID_SABufferInfo', 'SPVPRI_ALERT',
    'ISpeechMMSysAudio', 'DISPID_SGRSTType', 'SAFT22kHz16BitStereo',
    'SPEI_RECO_STATE_CHANGE', 'SREStreamEnd',
    'DISPID_SRCRetainedAudioFormat', 'SPPS_Verb', 'SPVOICESTATUS',
    'DISPID_SpeechLexiconProns', 'DISPID_SDKSetBinaryValue',
    'DISPID_SPRuleConfidence', 'DISPID_SLWLangId',
    'SPSTREAMFORMATTYPE', 'SRERecoOtherContext',
    'DISPID_SVAlertBoundary', 'ISpMMSysAudio', 'DISPID_SGRSTsItem',
    '_SPAUDIOSTATE', 'DISPID_SAStatus', 'SpeechWordType',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRGCmdLoadFromFile',
    'SPLOADOPTIONS', 'SAFT11kHz8BitStereo',
    'DISPID_SpeechWaveFormatEx', 'ISpDataKey', 'SPPS_SuppressWord',
    'DISPID_SpeechLexiconWords', 'DISPID_SGRSAddWordTransition',
    'eLEXTYPE_PRIVATE7', 'DISPID_SPPConfidence', 'SPVPRI_OVER',
    'SpPhoneConverter', 'SpNullPhoneConverter', 'SVP_2',
    'SAFT8kHz8BitMono', 'SGRSTTDictation', 'SRESoundEnd',
    'DISPID_SpeechLexiconWord', 'SAFTText', 'SAFT22kHz16BitMono',
    'DISPID_SBSRead', 'SPAR_Medium', 'SpeechTokenKeyUI',
    'SpeechTokenContext', 'SPAO_NONE', 'DISPID_SPIAudioSizeTime',
    'ISpeechPhraseAlternates', 'SPSLMA', 'SGSDisabled',
    'SPSHORTCUTPAIRLIST', 'SAFT32kHz16BitStereo', 'eLEXTYPE_PRIVATE9',
    'SPWT_LEXICAL', 'DISPID_SLPType', 'SAFT44kHz16BitStereo',
    'DISPID_SpeechRecoResult2', 'SPDATAKEYLOCATION',
    'SpCompressedLexicon', '_ISpeechRecoContextEvents',
    'SPRST_NUM_STATES', 'SPEI_TTS_PRIVATE', 'DISPID_SRIsShared',
    'SPSModifier', 'DISPID_SDKSetStringValue',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SpeechPhraseProperty',
    'eLEXTYPE_PRIVATE20', 'ISpResourceManager', 'eLEXTYPE_RESERVED6',
    'DISPID_SPAPhraseInfo', 'SPBINARYGRAMMAR', 'SpeechInterference',
    'SpeechPropertyResponseSpeed', 'SAFTCCITT_uLaw_22kHzStereo',
    'eWORDTYPE_DELETED', 'eLEXTYPE_PRIVATE15',
    'SAFTCCITT_uLaw_11kHzStereo', 'SITooLoud', 'DISPID_SVStatus',
    'SPPS_RESERVED1', 'SPPHRASEREPLACEMENT', 'LONG_PTR',
    'eLEXTYPE_PRIVATE11', 'SpMMAudioOut', 'SPEI_SR_RETAINEDAUDIO',
    'SDTAll', 'DISPID_SDKCreateKey', 'ISpeechPhraseInfoBuilder',
    'DISPID_SpeechObjectTokenCategory', 'SINoSignal',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SLPSymbolic',
    'SPSHT_NotOverriden', 'SAFT48kHz16BitMono', 'SECHighConfidence',
    ...
    'SAFT12kHz16BitStereo', 'SpInprocRecognizer', 'SPRULE',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRAudioInput',
    'DISPID_SVEVoiceChange', 'SpeechCategoryRecognizers',
    'DISPID_SGRClear', 'SGDSActiveWithAutoPause',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SPPId',
    'DISPID_SOTRemoveStorageFileName', 'SpeechStreamFileMode',
    'SPWF_SRENGINE', 'DISPID_SVVolume', 'SGRSTTRule', 'SP_VISEME_19',
    'DISPID_SVEventInterests', 'DISPID_SPAsItem',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SREPhraseStart', 'SPINTERFERENCE_LATENCY_WARNING',
    'IEnumSpObjectTokens', 'DISPID_SGRsAdd', 'SRCS_Enabled',
    'SP_VISEME_13', 'DISPID_SVSInputSentencePosition',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SWFEBlockAlign',
    'DISPID_SLWsItem', 'SRCS_Disabled',
    'SWPUnknownWordUnpronounceable', 'SpeechRegistryUserRoot',
    'SpeechAudioFormatGUIDWave', 'SECFIgnoreKanaType',
    'DISPID_SRGReset', 'DISPID_SVPriority', 'SAFT8kHz16BitMono',
    'SPLO_DYNAMIC', 'SVP_18', 'DISPID_SRGState',
    'ISpeechAudioBufferInfo', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SDKSetLongValue', 'ISpeechPhraseReplacements',
    'SAFT11kHz8BitMono', 'SRAONone', 'SDTDisplayText', 'SGDisplay',
    'ISpRecoResult', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRSSupportedLanguages', 'SPEI_TTS_BOOKMARK',
    'SpeechMicTraining', 'SPDKL_CurrentConfig', 'SPEVENTSOURCEINFO',
    'SPSERIALIZEDPHRASE', 'SpSharedRecognizer', 'DISPID_SPRsItem',
    'SPPARTOFSPEECH', 'SpeechLexiconType',
    'SpeechVoiceCategoryTTSRate', 'SRATopLevel',
    'ISpStreamFormatConverter', 'ISpeechLexiconWords',
    'SVSFParseAutodetect', 'SWTAdded', 'SPCS_DISABLED',
    'DISPID_SPPParent', 'SPXRO_Alternates_SML',
    'DISPID_SASNonBlockingIO', 'DISPID_SVWaitUntilDone',
    'DISPID_SpeechRecognizerStatus', 'SpeechVoiceSpeakFlags',
    'DISPID_SRCESoundStart', 'SSFMCreate', 'SPPHRASERULE',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SVSpeakStream',
    'DISPID_SPPEngineConfidence', 'SPTEXTSELECTIONINFO',
    'DISPID_SASState', 'SPVPRIORITY', 'DISPID_SPPs_NewEnum',
    'SGDSActive', 'eLEXTYPE_PRIVATE2', 'SSFMOpenReadWrite',
    ...
    'SpeechRuleState', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SBSSeek', 'SPINTERFERENCE_NOSIGNAL',
    'SAFTCCITT_ALaw_22kHzStereo', 'SECFEmulateResult',
    'DISPID_SVGetAudioInputs', 'DISPID_SGRsDynamic',
    'ISpNotifyTranslator', 'DISPID_SPCPhoneToId', 'SPSMF_UPS',
    'ISpShortcut', 'DISPID_SABIEventBias',
    'DISPID_SPEAudioStreamOffset', 'SPAS_RUN', 'SP_VISEME_15',
    'SpeechVisemeFeature', 'DISPID_SPIGrammarId', 'SDTProperty',
    'SPSEMANTICFORMAT', 'SP_VISEME_2', 'eLEXTYPE_PRIVATE12', 'SVP_14',
    'ISpeechLexiconPronunciations', 'ISpSerializeState',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SGRAddResource',
    'SPEI_SR_PRIVATE', 'DISPID_SRCEBookmark',
    'eLEXTYPE_USER_SHORTCUT', 'SDKLCurrentConfig',
    'SPEI_START_SR_STREAM', 'SPSNotOverriden', 'SPGS_ENABLED',
    'SPAR_Unknown', 'SPADAPTATIONRELEVANCE', 'STCRemoteServer',
    'DISPID_SABIMinNotification', 'SRADefaultToActive', 'SGLexical',
    'SGRSTTTextBuffer', 'tagSPTEXTSELECTIONINFO', 'SPEI_PHONEME',
    'SPEI_SOUND_END', '__MIDL_IWinTypes_0009', 'SP_VISEME_5',
    'SREStateChange', 'SVF_None', 'SDA_Consume_Leading_Spaces',
    'SAFT16kHz16BitMono', 'DISPID_SRGIsPronounceable', 'SP_VISEME_0',
    'SSSPTRelativeToStart', 'SRERecognition', 'SPINTERFERENCE_NONE',
    'DISPID_SPPsItem', 'ISpeechPhraseElement', 'SpeechRunState',
    'SpeechRecoContextState', 'SPWORDPRONOUNCEABLE', 'SPCT_SLEEP',
    'SFTInput', 'DISPID_SPEAudioSizeBytes', 'SpeechDisplayAttributes',
    'SPWT_PRONUNCIATION', 'ISpeechRecoGrammar',
    'DISPID_SGRSTPropertyId', 'SDTAlternates', 'SPAS_STOP',
    'SPEI_PHRASE_START', 'DISPID_SVSInputWordPosition', 'SpStream',
    'DISPID_SPRuleId', 'DISPID_SGRAddState', 'SVSFPurgeBeforeSpeak',
    'SPEI_FALSE_RECOGNITION', 'SDA_One_Trailing_Space',
    'DISPID_SVSVisemeId', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpVoice',
    'DISPID_SOTGetDescription', 'SpeechCategoryAudioIn',
    'SSFMCreateForWrite', 'DISPID_SGRSTWeight', 'ISpeechPhraseRules',
    'ISpPhraseAlt', 'SAFTDefault', 'SAFT24kHz16BitStereo',
    'SECFNoSpecialChars', 'SPCT_DICTATION',
    'DISPID_SVAudioOutputStream', 'DISPID_SRRTOffsetFromStart',
    'SP_VISEME_1', 'ISpeechObjectToken', 'SPSVerb',
    'DISPID_SGRSTs_NewEnum', 'SpeechVoiceEvents', 'SSFMOpenForRead',
    ...
    'SPLEXICONTYPE', 'Speech_Max_Word_Length',
    'SGDSActiveUserDelimited', 'SPCT_SUB_DICTATION',
    'SAFTNoAssignedFormat', 'SPFM_OPEN_READWRITE',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SPPValue',
    'DISPID_SVSPhonemeId', 'SVP_16', 'DISPID_SLGetPronunciations',
    'SpeechPartOfSpeech', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPEsItem', 'SAFT24kHz8BitStereo',
    'DISPID_SRCEPropertyStringChange', 'eLEXTYPE_MORPHOLOGY',
    'SVEAllEvents', 'DISPID_SpeechObjectToken', 'SVF_Emphasis',
    'ISpObjectToken', 'DISPID_SVResume', 'SPCATEGORYTYPE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPFM_OPEN_READONLY',
    'ISpeechVoiceStatus', 'SpWaveFormatEx', 'SpPhraseInfoBuilder',
    'SWTDeleted', 'DISPID_SPRText', 'SPEI_RESERVED1',
    'DISPID_SPRNumberOfElements', 'SINoise',
    'ISpPhoneticAlphabetConverter', 'eLEXTYPE_PRIVATE6',
    'DISPID_SVEStreamEnd', 'SPSHT_OTHER', 'SPEI_RECOGNITION',
    'DISPID_SOTRemove', 'SpStreamFormatConverter',
    'ISpeechRecoResultDispatch', 'SAFT48kHz16BitStereo',
    'SPEI_ADAPTATION', 'SP_VISEME_11', 'ISpeechRecoContext',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVSLastBookmarkId',
    'ISpStreamFormat', 'SAFTADPCM_11kHzMono',
    'IInternetSecurityMgrSite', 'SVEStartInputStream',
    'DISPID_SVSkip', 'DISPID_SWFEExtraData', 'SpeechAudioProperties',
    'SVEVoiceChange', 'Speech_Max_Pron_Length', 'SVEPrivate', 'SVP_4',
    'DISPID_SVVoice', 'SVEViseme', 'ISpGrammarBuilder',
    'ISpRecognizer2', 'SpeechCategoryVoices', 'DISPID_SGRsCommit',
    'DISPID_SPRFirstElement', 'DISPID_SPRulesCount',
    'DISPID_SGRsItem', 'SPEVENTENUM', 'SPRST_INACTIVE',
    'SAFTExtendedAudioFormat', 'SP_VISEME_4', 'ISpRecoGrammar2',
    'SPINTERFERENCE_NOISE', 'DISPID_SGRs_NewEnum', 'SPGRAMMARSTATE',
    'ISpeechCustomStream', 'SAFTCCITT_uLaw_8kHzMono', 'SECFDefault',
    'DISPID_SRCESoundEnd', 'DISPID_SAFGuid', 'DISPID_SLPs_NewEnum',
    'DISPID_SBSWrite', 'SpeechTokenKeyFiles',
    'DISPID_SPAStartElementInResult', 'DISPID_SVEStreamStart',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'STCLocalServer',
    'DISPID_SVEWord', 'SPPS_LMA', 'SDA_No_Trailing_Space',
    'DISPID_SRCSetAdaptationData', 'DISPID_SRRTStreamTime',
    'SPEI_RESERVED3', 'SPGS_EXCLUSIVE', 'SAFTADPCM_11kHzStereo',
    'SVP_19', 'ISpeechGrammarRule', 'SRSInactiveWithPurge',
    'SPAR_High', 'DISPID_SRGetRecognizers',
    'SpTextSelectionInformation', 'STSF_AppData',
    'DISPID_SRRAudioFormat', 'DISPID_SPPNumberOfElements',
    'SAFT48kHz8BitMono', 'DISPID_SPIGetText',
    'SpeechCategoryAppLexicons', 'ISpRecognizer', 'WAVEFORMATEX',
    'tagSTATSTG', 'SPWF_INPUT', 'SpeechRecoEvents', 'DISPID_SRRAudio',
    'SPCT_SUB_COMMAND', 'eLEXTYPE_PRIVATE13', 'SPFM_CREATE_ALWAYS',
    'DISPID_SpeechRecognizer', 'ISpeechGrammarRuleStateTransitions',
    'SPVISEMES', 'SGSExclusive', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SpeechLexicon', 'DISPID_SGRSTransitions',
    'DISPID_SPEAudioSizeTime', 'STCAll', 'eLEXTYPE_PRIVATE1',
    'SDKLDefaultLocation', 'tagSPPROPERTYINFO', 'SGRSTTEpsilon',
    ...
    'ISpeechObjectTokenCategory', 'DISPID_SRGRecoContext',
    'DISPID_SRStatus', 'DISPID_SAVolume', 'STSF_LocalAppData',
    'SAFT32kHz8BitMono', 'SPCONTEXTSTATE', 'DISPID_SpeechAudio',
    'SpeechRuleAttributes', 'SGRSTTWildcard', 'SAFTGSM610_8kHzMono',
    'SPPS_Interjection', 'DISPID_SRRSpeakAudio', 'DISPID_SASetState',
    'SREPropertyStringChange', 'ISpeechWaveFormatEx',
    'SSSPTRelativeToCurrentPosition', 'SGDSInactive', 'SPXRO_SML',
    'DISPID_SpeechPhraseReplacements', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SGRSTPropertyValue', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISpProperties', 'SPPHRASEPROPERTY', 'DISPID_SLGetWords',
    'DISPID_SVSpeak', 'SAFTCCITT_ALaw_44kHzMono', 'SPBOOKMARKOPTIONS',
    'DISPID_SPACommit', 'DISPID_SGRAttributes',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SVAudioOutput',
    'SpMMAudioEnum', 'ISpeechAudio', 'ISpeechObjectTokens',
    'SRSActive', 'SPEI_RECO_OTHER_CONTEXT', 'SDTAudio',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpInProcRecoContext',
    'DISPID_SVDisplayUI', 'SPEI_MAX_SR', 'DISPID_SLWs_NewEnum',
    'SPEI_RESERVED6', 'DISPID_SDKEnumValues', 'SAFT12kHz8BitMono',
    'SPFM_NUM_MODES', 'ISpeechDataKey', 'DISPID_SABIBufferSize',
    'SRSInactive', 'SPEI_INTERFERENCE', 'SpeechUserTraining',
    'SRTReSent', 'SAFT16kHz8BitMono', 'DISPID_SAEventHandle',
    'DISPID_SVEViseme', 'DISPID_SASFreeBufferSpace', 'DISPID_SVPause',
    'SVEAudioLevel', 'SRADynamic',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SLODynamic',
    'DISPID_SABufferNotifySize', 'ISpStream', 'DISPID_SVGetProfiles',
    ...
    'SASRun', 'SVSFIsFilename', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SVGetVoices', 'SVP_13', 'SPPS_Function',
    'ISpXMLRecoResult', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SRGSetWordSequenceData', 'SpeechCategoryAudioOut',
    'DISPID_SOTCDefault', 'SPPS_Noncontent', 'SRTExtendableParse',
    'eWORDTYPE_ADDED', 'SVSFPersistXML', 'SVPAlert',
    'DISPID_SRAudioInputStream', 'SPSEMANTICERRORINFO', 'SVP_6',
    'SPWT_DISPLAY', 'SINone', 'DISPID_SRCERequestUI',
    'DISPID_SMSAMMHandle', 'DISPID_SRGetPropertyString',
    'DISPID_SRCVoicePurgeEvent', 'SECLowConfidence', 'DISPID_SOTCId',
    'DISPID_SRSetPropertyString', 'SDTReplacement',
    'ISpeechPhraseInfo', 'DISPID_SLPsCount', 'eLEXTYPE_PRIVATE16',
    'SREPrivate', 'SPAUDIOBUFFERINFO', 'SVSFParseSapi',
    'DISPID_SDKGetlongValue', 'DISPID_SRRAlternates',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SpeechFileStream',
    'ISpeechResourceLoader', 'SAFTADPCM_8kHzMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_RESERVED9', 'DISPID_SpeechPhraseReplacement',
    'SpeechCategoryRecoProfiles', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SMSGetData', 'SPWORD', 'DISPID_SMSALineId', 'SpVoice',
    'DISPID_SWFESamplesPerSec', 'DISPID_SpeechRecoResult',
    'DISPID_SFSClose', 'DISPID_SRGDictationLoad',
    'SAFT32kHz8BitStereo', 'SLTUser', 'SAFT22kHz8BitStereo',
    'SpeechAudioFormatGUIDText', 'SVSFlagsAsync', 'ISpeechPhraseRule',
    'SVP_5', 'SVP_20', 'DISPID_SVSLastStreamNumberQueued',
    'ISpRecoContext2', 'SVSFUnusedFlags', 'SAFT16kHz8BitStereo',
    'DISPID_SLWsCount', 'DISPID_SpeechPhraseInfo', 'SPSInterjection',
    'DISPID_SPERequiredConfidence', 'ISpeechRecognizer',
    'ISpeechAudioFormat', 'IStream', 'SREBookmark',
    'SAFTCCITT_ALaw_11kHzMono', 'SPPHRASEELEMENT', 'SVPOver',
    'SPSHORTCUTPAIR', 'SPWORDLIST', 'SpeechBookmarkOptions',
    'SREStreamStart', 'DISPID_SGRInitialState',
    'DISPID_SRRGetXMLResult', 'DISPID_SLGetGenerationChange',
    'SPPS_Unknown', 'eLEXTYPE_PRIVATE14', 'ISpeechAudioStatus',
    'SPWORDPRONUNCIATION', 'DISPID_SRState', 'SP_VISEME_12',
    'DISPID_SDKDeleteValue', 'ISequentialStream',
    'SREFalseRecognition', 'eLEXTYPE_RESERVED10',
    'DISPID_SVESentenceBoundary', 'eLEXTYPE_APP',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SOTDisplayUI',
    'SGLexicalNoSpecialChars', 'SPEI_VOICE_CHANGE',
    'DISPID_SPPChildren', 'SPAS_CLOSED', 'SECFIgnoreCase',
    'DISPID_SMSADeviceId', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRCCmdMaxAlternates', 'SWPUnknownWordPronounceable',
    'DISPID_SPRsCount', 'DISPID_SRGId', 'DISPID_SRCEAudioLevel',
    'DISPID_SRRRecoContext', 'DISPID_SLWType', 'SVEPhoneme',
    'DISPID_SLPLangId', 'SREInterference', 'DISPID_SPARecoResult',
    'DISPID_SPRs_NewEnum', 'SSTTWildcard', 'SPCS_ENABLED',
    'SRAORetainAudio', 'DISPID_SRGCmdLoadFromObject',
    'SAFTGSM610_11kHzMono', 'SECNormalConfidence',
    'SpeechAddRemoveWord', 'DISPID_SRCPause', 'SPAS_PAUSE',
    'DISPID_SWFEChannels', 'DISPID_SPPsCount', 'SPEI_SR_BOOKMARK',
    'DISPID_SWFEBitsPerSample', 'DISPID_SPEDisplayAttributes',
    'SECFIgnoreWidth', 'SP_VISEME_3', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPAs_NewEnum',
    'SAFTCCITT_ALaw_8kHzMono', 'SPRECORESULTTIMES', 'STCInprocServer',
    'DISPID_SPRuleChildren', 'SPGS_DISABLED',
    ...
    'DISPID_SRCEPhraseStart', 'DISPID_SOTCategory', 'SPAUDIOSTATE',
    'DISPIDSPTSI', 'DISPID_SRGCommit', 'DISPID_SRGDictationSetState',
    'ISpeechBaseStream', 'eLEXTYPE_PRIVATE19', 'SpShortcut',
    'SP_VISEME_7', 'DISPID_SpeechGrammarRuleState', 'SPEI_UNDEFINED',
    'ISpeechGrammarRules', 'SPRS_INACTIVE', 'DISPID_SGRsFindRule',
    'DISPID_SRGDictationUnload', 'DISPID_SPPFirstElement',
    'DISPID_SGRId', 'SPPS_Modifier', 'SP_VISEME_18', 'SpAudioFormat',
    'ISpeechXMLRecoResult', 'ISpeechLexiconPronunciation',
    'DISPID_SRSetPropertyNumber', 'SPRECOCONTEXTSTATUS', 'SVP_21',
    'SLOStatic', 'SPRST_ACTIVE'
]

_check_version('1.2.0', 1700048362.404315)
